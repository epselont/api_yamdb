# Generated by Django 2.2.16 on 2022-06-02 21:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(through='reviews.Genre_title', to='reviews.Genres')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.AddField(
            model_name='genre_title',
            name='title',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='title', to='reviews.Titles', verbose_name='Категория'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
